...
class IndicadoresDesempeño:
    ...
    def __init__(self, datos_limpiados):
        ...
        required_base = ['Player', 'Pos', 'G', 'MP', 'PTS', 'AST', 'TRB', 'STL', 'BLK', 'TOV', 'FG', 'FGA', 'FT', 'FTA', '3P']
    ...
    def _calcular_metricas_avanzadas(self):
        ...
        if self.datos is None or not all(col in self.datos.columns for col in ['FGA_Total', 'FG_Total', 'FTA_Total', 'FT_Total', 'PTS_Total', 'TRB_Total', 'AST_Total', 'STL_Total', 'BLK_Total', 'TOV_Total', 'MP_Total']):
        ...
        calculated_cols = ['EFF', 'EFF/MIN', 'TS%', 'eFG%_calculated', 'Off_Rating_Simple', 'Def_Rating_Placeholder', 'Net_Rating_Simple']
