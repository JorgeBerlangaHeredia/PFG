...
class Alineación:
    ...
    *** VERSIÓN ORIGINAL: Considera TODAS las posiciones listadas para cada jugador. ***
    ...
    def __init__(self, datos_con_metricas, tipo_ali="equilibrada", min_g=15, min_mp_total=300):
        ...
        self.metric_map = {
            ...
            'defensiva': 'Def_Rating_Placeholder', # ¡Cuidado con esta!
            'equilibrada': 'EFF/MIN'
        }
        ...
        # <<<--- NOTA ELIMINADA sobre 1ra Pos --->>>


    # >>>>>>>>>> LÓGICA DE POSICIÓN RESTAURADA A MULTI-POSICIÓN <<<<<<<<<<
    def _get_eligible_players(self, target_pos, excluded_players=[]):
        ...
        # Filtrado inicial por minutos y juegos JUGADOS
        try:
        ...
        # Iterar sobre los jugadores que cumplen el umbral
    ...
    def crear_alineacion(self):
        ...
        y considerando todas las posiciones listadas.
    ...
    def mostrar_alineacion_df(self, titulares, suplentes):
        ...
        if suplentes_validos:
            ...
            print("No se seleccionaron suplentes válidos (puede ser por filtros o falta de jugadores).")
        print("------------------------------------------")
